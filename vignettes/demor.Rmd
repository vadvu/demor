...
ex1 <- prob.proj(mort.m, 
                 ...
                 migr = NULL,
                 time.n = 10, 
                 sims = 100, #this is toy example, better to use at least 1000
                 tfr.boot = F, 
                 clusters = 1,
                 pp = 1
                 )
...
Population projection (closed population): 

```{r}
ex1[[1]] %>% 
  ggplot(aes(x = year))+
  theme_linedraw()+
  geom_ribbon(aes(ymin = `0.025pop`, ymax = `0.975pop`, fill = "95%"),
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.05pop`, ymax = `0.95pop`, fill = "90%"), 
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.1pop`, ymax = `0.9pop`, fill = "80%"),
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.25pop`, ymax = `0.75pop`, fill = "50%"),
              alpha = 1)+
  geom_line(aes(y = `0.5pop`), #point = median
            color = "black", linewidth = 1)+
  geom_ribbon(aes(ymin = `0.5pop`, ymax = `0.5pop`, fill = "Median"))+
  scale_y_continuous(labels = scales::unit_format(unit = "mln", scale = 1e-6))+
  labs(y = "Population", x = "Year", fill = "Percentile:")+
  scale_x_continuous(breaks = seq(min(ex1[[1]]$year), max(ex1[[1]]$year), 4))+
  scale_fill_manual(values = c("grey", "red", "darkorange", "forestgreen", "black"))+
...
ex1[[1]] %>% 
  ggplot(aes(x = year))+
  theme_linedraw()+
  geom_ribbon(aes(ymin = `0.025tfr`, ymax = `0.975tfr`, fill = "95%"),
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.05tfr`, ymax = `0.95tfr`, fill = "90%"), 
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.1tfr`, ymax = `0.9tfr`, fill = "80%"),
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.25tfr`, ymax = `0.75tfr`, fill = "50%"),
              alpha = 1)+
  geom_line(aes(y = `0.5tfr`), 
            color = "black", linewidth = 1)+
  geom_ribbon(aes(ymin = `0.5tfr`, ymax = `0.5tfr`, fill = "Median"))+
  labs(y = "TFR", x = "Year")+
...
e0m.proj <- ex1[[1]] %>% 
  ggplot(aes(x = year))+
  theme_linedraw()+
  geom_ribbon(aes(ymin = `0.025e0m`, ymax = `0.975e0m`, fill = "95%"),
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.05e0m`, ymax = `0.95e0m`, fill = "90%"), 
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.1e0m`, ymax = `0.9e0m`, fill = "80%"),
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.25e0m`, ymax = `0.75e0m`, fill = "50%"),
              alpha = 1)+
  geom_line(aes(y = `0.5e0m`), 
            color = "black", linewidth = 1)+
  geom_ribbon(aes(ymin = `0.5e0m`, ymax = `0.5e0m`, fill = "Median"))+
  labs(y = "Le male", x = "Year")+
  scale_x_continuous(breaks = seq(min(ex1[[1]]$year), max(ex1[[1]]$year), 2))+
  scale_fill_manual(values = c("grey", "red", "darkorange", "forestgreen", "black"))+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
e0f.proj <- ex1[[1]] %>% 
  ggplot(aes(x = year))+
  theme_linedraw()+
  geom_ribbon(aes(ymin = `0.025e0f`, ymax = `0.975e0f`, fill = "95%"),
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.05e0f`, ymax = `0.95e0f`, fill = "90%"), 
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.1e0f`, ymax = `0.9e0f`, fill = "80%"),
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.25e0f`, ymax = `0.75e0f`, fill = "50%"),
              alpha = 1)+
  geom_line(aes(y = `0.5e0f`), 
            color = "black", linewidth = 1)+
  geom_ribbon(aes(ymin = `0.5e0f`, ymax = `0.5e0f`, fill = "Median"))+
  labs(y = "LE female", x = "Year")+
  scale_x_continuous(breaks = seq(min(ex1[[1]]$year), max(ex1[[1]]$year), 2))+
  scale_fill_manual(values = c("grey", "red", "darkorange", "forestgreen", "black"))+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
dep.old <- ex1[[1]] %>% 
  ggplot(aes(x = year))+
  theme_linedraw()+
  geom_ribbon(aes(ymin = `0.025old.dependency`, ymax = `0.975old.dependency`, fill = "95%"),
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.05old.dependency`, ymax = `0.95old.dependency`, fill = "90%"), 
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.1old.dependency`, ymax = `0.9old.dependency`, fill = "80%"),
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.25old.dependency`, ymax = `0.75old.dependency`, fill = "50%"),
              alpha = 1)+
  geom_line(aes(y = `0.5old.dependency`), 
            color = "black", linewidth = 1)+
  geom_ribbon(aes(ymin = `0.5old.dependency`, ymax = `0.5old.dependency`, fill = "Median"))+
...
dep.all <- ex1[[1]] %>% 
  ggplot(aes(x = year))+
  theme_linedraw()+
  geom_ribbon(aes(ymin = `0.025dependency`, ymax = `0.975dependency`, fill = "95%"),
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.05dependency`, ymax = `0.95dependency`, fill = "90%"), 
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.1dependency`, ymax = `0.9dependency`, fill = "80%"),
              alpha = 1)+
  geom_ribbon(aes(ymin = `0.25dependency`, ymax = `0.75dependency`, fill = "50%"),
              alpha = 1)+
  geom_line(aes(y = `0.5dependency`), 
            color = "black", linewidth = 1)+
  geom_ribbon(aes(ymin = `0.5dependency`, ymax = `0.5dependency`, fill = "Median"))+
