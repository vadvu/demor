...
For the analysis of fertility in the `demor` there are only a few (2...) functions, due to the author's preference for mortality analysis...
...
Another function is `ages` that converts continuous ages to age groups. For example, array with $\{ 0,1,2,3...100 \}$ it can convert to $\{<5,6-9,10-14 ... 85+ \}$ using user-specific lower boundaries.
