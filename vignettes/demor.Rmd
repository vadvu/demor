...
les <- leslie(mx = mx, fx = fx, age.mx = 0:100, age.fx = 15:55, sex = "f")
...
const.mx = matrix(rep(mx, each = 78), nrow = length(mx), byrow = TRUE)
const.fx = matrix(rep(fx, each = 78), nrow = length(fx), byrow = TRUE)

Nt <- ccm(Mx = const.mx, Fx = const.fx, age.mx = 0:100, age.fx = 15:55, N0 = N0, sex = "f")
